void rmacro(){
    ...
    const int nf = 11;
    TString fname[nf] = {"out_MeV_150.root", "out_MeV_170.root", "out_MeV_190.root", "out_MeV_210.root", "out_MeV_230.root", "out_MeV_250.root", "out_MeV_270.root", "out_MeV_290.root", "out_MeV_310.root", "out_MeV_330.root", "out_MeV_350.root"};
    TFile* readfile[nf];
    TH1D* BraggHist[nf];
    TH1D* histcopy[nf];
    gStyle->SetOptStat(0);
    ...
    BraggHist[i]->SetTitle("Braggovy krivky protonu o ruznych energiich ve vode");
